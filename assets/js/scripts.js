...
$(document).ready(function () {
  ...
  document.querySelector('#hour-10 .description').value = localStorage.getItem('hour-10');
  document.querySelector('#hour-11 .description').value = localStorage.getItem('hour-11');
  document.querySelector('#hour-12 .description').value = localStorage.getItem('hour-12');
  document.querySelector('#hour-13 .description').value = localStorage.getItem('hour-13');
  document.querySelector('#hour-14 .description').value = localStorage.getItem('hour-14');
  document.querySelector('#hour-15 .description').value = localStorage.getItem('hour-15');
  document.querySelector('#hour-16 .description').value = localStorage.getItem('hour-16');
  document.querySelector('#hour-17 .description').value = localStorage.getItem('hour-17');
  
  /**
   * The above function displays the current date and time in the header.
   */
  function displayTime () {
    var todaysDate = dayjs().format('dddd, MMMM DD, YYYY, h:mm:ss A');
